...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 19:59:26 2021
...
def ValuePredictor(to_predict_list, size):
    ...
    loaded_model = joblib.load(userhome + r'/Desktop/Python/End2EndProjects/Netflix_API/netflix_model.pkl')
...
def plot():
    if request.method == "POST":
        loaded_model, X_Predict, df = joblib.load(userhome + r'/Desktop/Python/End2EndProjects/Netflix_API/netflix_forecast_model.pkl')
        ...
        plt.xlabel('Time')
        plt.ylabel('Price')
        img_addr = userhome + r'/Desktop/Python/End2EndProjects/Netflix_API/static/img/plot.png'
